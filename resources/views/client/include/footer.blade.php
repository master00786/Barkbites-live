                ...
                <div class="row border-bottom">
                    <div class="col-md-4">
                        ...
                        <p class="text-secondary">
                            Pet Zone BD is an online pet shop in Jajmau Kanpur, Uttar Pradesh providing your loving pets with their
...
{{--                            <a class="d-block py-2 text-secondary" href="#"> Cat Food</a>--}}
                ...
                <p class="pt-4">
                    © 2022 BarkBites. All Rights Reserved. Designed by
                    <a href="#"> Mohd.Sonu Kumar</a>
                </p>
            </div>
        </div>
    </div>
